...
export interface Service<TReqArgs extends any[] = [], TResArgs extends any[] = []> {
  getTextValue(request: GetTextValueRequest, ...args: TReqArgs): RpcReturnType<Promise<GetTextValueResponse>, TResArgs>;
  getSliderValue(request: GetSliderValueRequest, ...args: TReqArgs): RpcReturnType<AsyncGenerator<GetSliderValueResponse>, TResArgs>;
}
...
export const methodDescriptors = {
  getTextValue: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetTextValueRequest) => JSON.stringify(encodeJson(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_1,
      deserializeBinary: decodeBinary_1,
      serializeJson: (value: GetTextValueResponse) => JSON.stringify(encodeJson_1(value)),
    },
  },
  getSliderValue: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetSliderValueRequest) => JSON.stringify(encodeJson_2(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_3,
      deserializeBinary: decodeBinary_3,
      serializeJson: (value: GetSliderValueResponse) => JSON.stringify(encodeJson_3(value)),
    },
  },
} as const;
